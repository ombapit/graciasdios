{include file="breadcrumb.tpl" icon="fa-book" bc="Master Data <span>> Suppliers > Manage {$module_alias} > {$cond} {$module_alias}</span>"}
<!-- widget grid -->
							...
							<fieldset>
								<div class="row">
									<section class="col col-4">
										Nama Supplier
										<label class="input">
											<input type="text" placeholder="Nama Supplier" name="nama_supplier" value="{$detail['nama_supplier']}">
										</label>
									</section>
								</div>
								<div class="row">
...
// DO NOT REMOVE : GLOBAL FUNCTIONS!
	...
	function runFormValidation() {
		var $form1 = $("#form1").validate({
			...
			messages : {
				nama_supplier : {
					required : 'Please enter your Nama Supplier'
				},
				alamat : {
