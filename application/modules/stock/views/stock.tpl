{include file="breadcrumb.tpl" icon="fa-book" bc="Master Data <span>> {$module_alias}</span>"}
<!-- widget grid -->
						...
						<table id="datatable_fixed_column" class="table table-striped table-bordered smart-form">
							<thead>
								<tr>
									...
									<th>Ukuran (MM)</th>
									<th>Berat (Kg)</th>
									<th>Quantity Jakarta</th>
									<th>Quantity Surabaya</th>
								</tr>
								<tr class="second">
									<td>
										<label class="input">
											<input type="text" name="nama_tipe" value="Filter Jenis Barang" class="search_init">
										</label>
									</td>
									<td>
										<label class="input">
											<input type="text" name="kode_barang" value="Filter Kode Barang" class="search_init">
										</label>
									</td>
									<td>
										<label class="input">
											<input type="text" name="nama_barang" value="Filter Nama Barang" class="search_init">
										</label>
									</td>
									<td>
										&nbsp;
									...
									<td>
										<label class="input">
											<input type="text" name="berat" value="Filter Berat" class="search_init">
										</label>
									</td>
									<td>
										&nbsp;
