				...
				<div>
					...
					<div class="widget-body">
						<form class="smart-form" id="form1" method="post" action="{php}echo site_url();{/php}/{$module}/{$stat_cond}" novalidate="novalidate">
							...
							<input type="hidden" name="idgroup" id="idgroup" value="{$detail['idgroup']}"/>
							<fieldset>
								<div class="row">
									<section class="col col-4">
										Nama Group
										<label class="input">
											<input type="text" placeholder="Nama Group" name="nama" value="{$detail['nama']}">
										</label>
									</section>
								</div>
							</fieldset>
...
// DO NOT REMOVE : GLOBAL FUNCTIONS!
	...
	function runFormValidation() {
		var $form1 = $("#form1").validate({
			...
			messages : {
				nama : {
					required : 'Please enter your Nama Group'
				}
			},
