				...
				<div>
					...
					<div class="widget-body">
						<form class="smart-form" id="form1" method="post" action="{php}echo site_url();{/php}/{$module}/{$stat_cond}" novalidate="novalidate">
							...
							<input type="hidden" name="idsubgroup" id="idsubgroup" value="{$detail['idsubgroup']}"/>
							<fieldset>
								<div class="row">
								...
								<div class="row">
									<section class="col col-2">
										Kode
										<label class="input">
											<input type="text" placeholder="Kode" name="kode" value="{$detail['kode']}">
										</label>
									</section>
									<section class="col col-4">
										Nama Subgroup
										<label class="input">
											<input type="text" placeholder="Nama Subgroup" name="nama" value="{$detail['nama']}">
										</label>
									</section>
								</div>
							</fieldset>
	...
	function runFormValidation() {
		var $form1 = $("#form1").validate({
			...
			messages : {
				...
				nama : {
					required : 'Please enter your Nama Subgroup'
				}
			},
