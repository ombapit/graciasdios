{include file="breadcrumb.tpl" icon="fa-list-alt" bc="Transaksi <span> > Pembelian > Manage {$module_alias}</span>"}
<!-- widget grid -->
						...
						<table id="datatable_fixed_column" class="table table-striped table-bordered smart-form">
							<thead>
								...
								<tr class="second">
									<td>
										<label class="input">
											<input type="text" name="ref_code" value="Filter Ref Code" class="search_init">
										</label>
									</td>
									<td>
										<label class="input">
											<input type="text" name="supplier" value="Filter Supplier" class="search_init">
										</label>
									</td>
									<td>
										<label class="input">
											<input type="text" name="tanggal_pembelian" value="Filter Tanggal Pembelian" class="search_init">
										</label>
									</td>
									<td>
										<label class="input">
											<input type="text" name="created_by" value="Filter Dibuat Oleh" class="search_init">
										</label>
									</td>
									<td>
										&nbsp;
