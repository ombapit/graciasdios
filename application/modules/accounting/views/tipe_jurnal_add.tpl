				...
				<div>
					...
					<div class="widget-body">
						<form class="smart-form" id="form1" method="post" action="{php}echo site_url();{/php}/{$module}/{$stat_cond}" novalidate="novalidate">
							...
							<input type="hidden" name="idtipe_jurnal" id="idtipe_jurnal" value="{$detail['idtipe_jurnal']}"/>
							<fieldset>
								<div class="row">
									<section class="col col-2">
										Kode Jurnal
										<label class="input">
											<input type="text" placeholder="Kode Jurnal" name="kode" value="{$detail['kode']}">
										</label>
									</section>
									<section class="col col-4">
										Nama Jurnal
										<label class="input">
											<input type="text" placeholder="Nama Jurnal" name="nama" value="{$detail['nama']}">
										</label>
									</section>
								</div>
							</fieldset>
	...
	function runFormValidation() {
		var $form1 = $("#form1").validate({
			...
			messages : {
				...
				nama : {
					required : 'Please enter your Nama Jurnal'
				}
			},
