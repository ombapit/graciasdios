						...
						<table id="datatable_fixed_column" class="table table-striped table-bordered smart-form">
							<thead>
								...
								<tr class="second">
									<td>
										<label class="input">
											<input type="text" name="group_name" value="Filter Nama Group" class="search_init">
										</label>
									</td>
									<td>
										<label class="input">
											<input type="text" name="subgroup_name" value="Filter Nama Subroup" class="search_init">
										</label>
									</td>
									<td>
										<label class="input">
											<input type="text" name="mata_uang" value="Filter Nama Mata uang" class="search_init">
										</label>
									</td>
									<td>
										<label class="input">
											<input type="text" name="kode" value="Filter Kode" class="search_init">
										</label>
									</td>
									<td>
										<label class="input">
											<input type="text" name="nama_akun" value="Filter Nama Account" class="search_init">
										</label>
									</td>
									<td>
										&nbsp;
