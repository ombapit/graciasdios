						...
						<table id="datatable_fixed_column" class="table table-striped table-bordered smart-form">
							<thead>
								...
								<tr class="second">
									<td>
										<label class="input">
											<input type="text" name="nama_supplier" value="Filter Nama Supplier" class="search_init">
										</label>
									</td>
									<td>
										<label class="input">
									...
									<td>
										<label class="input">
											<input type="text" name="nama_tipe" value="Filter Tipe Supplier" class="search_init">
										</label>
									</td>
									<td>
										<label class="input">
