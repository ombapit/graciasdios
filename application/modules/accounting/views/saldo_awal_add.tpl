				...
				<div>
					...
					<div class="widget-body">
						<form class="smart-form" id="form1" method="post" action="{php}echo site_url();{/php}/{$module}/{$stat_cond}" novalidate="novalidate">
							...
							<input type="hidden" name="idsaldo_awal" id="idsaldo_awal" value="{$detail['idsaldo_awal']}"/>
							<fieldset>
								<div class="row">
								...
								<div class="row">
									<section class="col col-2">
										Debet
										<label class="input">
											<input type="text" placeholder="Debet" name="debet" value="{$detail['debet']}">
										</label>
									</section>
									<section class="col col-2">
										Kredit
										<label class="input">
											<input type="text" placeholder="Kredit" name="kredit" value="{$detail['kredit']}">
										</label>
									</section>
								</div>
							</fieldset>
...
// DO NOT REMOVE : GLOBAL FUNCTIONS!
	...
	function runFormValidation() {
		var $form1 = $("#form1").validate({
			...
			messages : {
				idperiode : {
					required : 'Please select your Periode'
				},
				idaccount : {
