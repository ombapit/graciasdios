...
<script type="text/javascript">
	...
	function runDataTables() {
		//select filter
		$("#datatable_fixed_column thead select").change(function() {
			oTable.fnFilter(this.value, oTable.oApi._fnVisibleToColumnIndex(oTable.fnSettings(), $("thead select").index(this)));
		});
		$("#datatable_fixed_column thead select").each(function(i) {
			this.initVal = this.value;
		});
		$("#datatable_fixed_column thead select").focus(function() {
			if (this.className == "search_init") {
				this.className = "";
				this.value = "";
			}
		});
		$("#datatable_fixed_column thead select").blur(function(i) {
			if (this.value == "") {
