{include file="breadcrumb.tpl" icon="fa-wrench" bc="Settings <span>> Table Reference</span> <span>> {$module_alias}</span>"}
<!-- widget grid -->
						...
						<table id="datatable_fixed_column" class="table table-striped table-bordered smart-form">
							<thead>
								...
								<tr class="second">
									<td>
										<label class="input">
											<input type="text" name="nilai" value="Filter Nilai" class="search_init">
										</label>
									</td>
									<td>
										<label class="input">
											<input type="text" name="satuan" value="Filter Satuan" class="search_init">
										</label>
									</td>
									<td>
										&nbsp;
