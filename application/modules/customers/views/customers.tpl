						...
						<table id="datatable_fixed_column" class="table table-striped table-bordered smart-form">
							<thead>
								...
								<tr class="second">
									<td>
										<label class="input">
											<input type="text" name="nama_customer" value="Filter Nama Customer" class="search_init">
										</label>
									</td>
									<td>
										<label class="input">
											<input type="text" name="tipe_customer" value="Filter Tipe Customer" class="search_init">
										</label>
									</td>
									<td>
										<label class="input">
									...
									<td>
										<label class="input">
											<input type="text" name="telp" value="Filter Telp" class="search_init">
										</label>
									</td>
									<td>
										<label class="input">
											<input type="text" name="fax" value="Filter Fax" class="search_init">
										</label>
									</td>
									<td>
										&nbsp;
