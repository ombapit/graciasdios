						...
						<table id="datatable_fixed_column" class="table table-striped table-bordered smart-form">
							<thead>
								...
								<tr class="second">
									<td>
										<label class="input">
											<input type="text" name="nama_periode" value="Filter Period Name" class="search_init">
										</label>
									</td>
									<td>
										<label class="input">
											<input type="text" name="start" value="Filter Start Period" class="search_init">
										</label>
									</td>
									<td>
										<label class="input">
											<input type="text" name="end" value="Filter End Period" class="search_init">
										</label>
									</td>
									<td>
										&nbsp;
