				...
				<div>
					...
					<div class="widget-body">
						<form class="smart-form" id="form1" method="post" action="{php}echo site_url();{/php}/{$module}/{$stat_cond}" novalidate="novalidate">
							...
							<input type="hidden" name="idref" id="idref" value="{$detail['idref']}"/>
							<fieldset>
								<div class="row">
									<section class="col col-4">
										Nama Center Support
										<label class="input">
											<input type="text" placeholder="Nama Center Support" name="nilai" value="{$detail['nilai']}">
										</label>
									</section>
								</div>
							</fieldset>
...
// DO NOT REMOVE : GLOBAL FUNCTIONS!
	...
	function runFormValidation() {
		var $form1 = $("#form1").validate({
			...
			messages : {
				nilai : {
					required : 'Please enter your Nama Footplate'
				}
			},
